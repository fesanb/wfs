...
class Bessel(CtrlNode):
	...
	uiTemplate = [
		...
		('cutoff', 'spin',
		 {'value': 1000., 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'Hz', 'siPrefix': True}),
...
class Butterworth(CtrlNode):
	...
	uiTemplate = [
		...
		('wPass', 'spin',
		 {'value': 1000., 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'Hz', 'siPrefix': True}),
		('wStop', 'spin',
		 {'value': 2000., 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'Hz', 'siPrefix': True}),
		('gPass', 'spin',
		 {'value': 2.0, 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'dB', 'siPrefix': True}),
		('gStop', 'spin',
		 {'value': 20.0, 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'dB', 'siPrefix': True}),
		('bidir', 'check', {'checked': True})
	]
...
class ButterworthNotch(CtrlNode):
	...
	uiTemplate = [
		...
		('low_gStop', 'spin',
		 {'value': 20.0, 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'dB', 'siPrefix': True}),
		('high_wPass', 'spin',
		 {'value': 3000., 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'Hz', 'siPrefix': True}),
		('high_wStop', 'spin',
		 {'value': 4000., 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'Hz', 'siPrefix': True}),
		('high_gPass', 'spin',
		 {'value': 2.0, 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'dB', 'siPrefix': True}),
		('high_gStop', 'spin',
		 {'value': 20.0, 'step': 1, 'dec': True, 'range': [0.0, None], 'suffix': 'dB', 'siPrefix': True}),
