...
from ..Qt import QtGui, USE_PYSIDE, USE_PYQT5
	...
	def checkException(self, excType, exc, tb):
		...
		if excType is AttributeError:
			...
			if filename.endswith('MetaArray.py') and function == '__getattr__':
				for name in ('__array_interface__', '__array_struct__',
							 '__array__'):  ## numpy looks for these when converting objects to array
					if name in exc:
						return False
