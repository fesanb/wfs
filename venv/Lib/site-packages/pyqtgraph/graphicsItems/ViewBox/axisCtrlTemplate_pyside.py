...
class Ui_Form(object):
	...
	def retranslateUi(self, Form):
		...
		self.autoPercentSpin.setToolTip(QtGui.QApplication.translate("Form",
		...
		self.autoRadio.setToolTip(QtGui.QApplication.translate("Form",
		...
		self.manualRadio.setToolTip(QtGui.QApplication.translate("Form",
		...
		self.minText.setToolTip(QtGui.QApplication.translate("Form",
		...
		self.maxText.setToolTip(QtGui.QApplication.translate("Form",
		...
		self.invertCheck.setToolTip(QtGui.QApplication.translate("Form",
																 "<html><head/><body><p>Inverts the display of this axis. (+y points downward instead of upward)</p></body></html>",
																 None, QtGui.QApplication.UnicodeUTF8))
		self.invertCheck.setText(
			QtGui.QApplication.translate("Form", "Invert Axis", None, QtGui.QApplication.UnicodeUTF8))
		self.mouseCheck.setToolTip(QtGui.QApplication.translate("Form",
																"<html><head/><body><p>Enables mouse interaction (panning, scaling) for this axis.</p></body></html>",
																None, QtGui.QApplication.UnicodeUTF8))
		self.mouseCheck.setText(
			QtGui.QApplication.translate("Form", "Mouse Enabled", None, QtGui.QApplication.UnicodeUTF8))
		self.visibleOnlyCheck.setToolTip(QtGui.QApplication.translate("Form",
																	  ...
																	  None, QtGui.QApplication.UnicodeUTF8))
		self.visibleOnlyCheck.setText(
			QtGui.QApplication.translate("Form", "Visible Data Only", None, QtGui.QApplication.UnicodeUTF8))
		self.autoPanCheck.setToolTip(QtGui.QApplication.translate("Form",
																  ...
																  None, QtGui.QApplication.UnicodeUTF8))
		self.autoPanCheck.setText(
			QtGui.QApplication.translate("Form", "Auto Pan Only", None, QtGui.QApplication.UnicodeUTF8))
