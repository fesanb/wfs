...
class Ui_Form(object):
	...
	def retranslateUi(self, Form):
		...
		self.averageGroup.setToolTip(_translate("Form",
		...
		self.clipToViewCheck.setToolTip(_translate("Form",
		...
		self.maxTracesCheck.setToolTip(_translate("Form",
		...
		self.peakRadio.setToolTip(_translate("Form",
		...
		self.maxTracesSpin.setToolTip(_translate("Form",
												 ...
												 None))
		self.forgetTracesCheck.setToolTip(_translate("Form",
		...
		self.subsampleRadio.setToolTip(_translate("Form",
		...
		self.autoDownsampleCheck.setToolTip(_translate("Form",
		...
		self.downsampleSpin.setToolTip(
			_translate("Form", "Downsample data before plotting. (plot every Nth sample)", None))
