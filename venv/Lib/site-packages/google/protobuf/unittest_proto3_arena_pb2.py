...
_TESTALLTYPES = _descriptor.Descriptor(
	...
	fields=[
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_nested_message', full_name='proto3_arena_unittest.TestAllTypes.optional_nested_message',
			index=15,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_foreign_message', full_name='proto3_arena_unittest.TestAllTypes.optional_foreign_message',
			index=16,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_import_message', full_name='proto3_arena_unittest.TestAllTypes.optional_import_message',
			index=17,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_foreign_enum', full_name='proto3_arena_unittest.TestAllTypes.optional_foreign_enum',
			index=19,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_string_piece', full_name='proto3_arena_unittest.TestAllTypes.optional_string_piece',
			index=20,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='proto3_arena_unittest.TestAllTypes.optional_public_import_message', index=22,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_lazy_message', full_name='proto3_arena_unittest.TestAllTypes.optional_lazy_message',
			index=23,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='proto3_arena_unittest.TestAllTypes.optional_lazy_import_message', index=24,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_nested_message', full_name='proto3_arena_unittest.TestAllTypes.repeated_nested_message',
			index=40,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_foreign_message', full_name='proto3_arena_unittest.TestAllTypes.repeated_foreign_message',
			index=41,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_import_message', full_name='proto3_arena_unittest.TestAllTypes.repeated_import_message',
			index=42,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_foreign_enum', full_name='proto3_arena_unittest.TestAllTypes.repeated_foreign_enum',
			index=44,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_string_piece', full_name='proto3_arena_unittest.TestAllTypes.repeated_string_piece',
			index=45,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=_b('\010\001'), file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_lazy_message', full_name='proto3_arena_unittest.TestAllTypes.repeated_lazy_message',
			index=47,
...
_TESTUNPACKEDTYPES = _descriptor.Descriptor(
	...
	fields=[
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=_b('\020\000'), file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_nested_enum', full_name='proto3_arena_unittest.TestUnpackedTypes.repeated_nested_enum',
			index=13,
...
_TESTALLTYPES.fields_by_name[
	'optional_lazy_import_message'].message_type = google_dot_protobuf_dot_unittest__import__pb2._IMPORTMESSAGE
