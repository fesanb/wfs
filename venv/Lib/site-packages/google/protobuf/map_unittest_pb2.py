...
DESCRIPTOR = _descriptor.FileDescriptor(
	...
	dependencies=[google_dot_protobuf_dot_unittest__pb2.DESCRIPTOR,
				  google_dot_protobuf_dot_unittest__no__arena__pb2.DESCRIPTOR, ])
...
_TESTMAP = _descriptor.Descriptor(
	...
	fields=[
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='map_string_foreign_message', full_name='protobuf_unittest.TestMap.map_string_foreign_message',
			index=17,
	...
	nested_types=[_TESTMAP_MAPINT32INT32ENTRY, _TESTMAP_MAPINT64INT64ENTRY, _TESTMAP_MAPUINT32UINT32ENTRY,
				  _TESTMAP_MAPUINT64UINT64ENTRY, _TESTMAP_MAPSINT32SINT32ENTRY, _TESTMAP_MAPSINT64SINT64ENTRY,
				  _TESTMAP_MAPFIXED32FIXED32ENTRY, _TESTMAP_MAPFIXED64FIXED64ENTRY, _TESTMAP_MAPSFIXED32SFIXED32ENTRY,
				  _TESTMAP_MAPSFIXED64SFIXED64ENTRY, _TESTMAP_MAPINT32FLOATENTRY, _TESTMAP_MAPINT32DOUBLEENTRY,
				  _TESTMAP_MAPBOOLBOOLENTRY, _TESTMAP_MAPSTRINGSTRINGENTRY, _TESTMAP_MAPINT32BYTESENTRY,
				  _TESTMAP_MAPINT32ENUMENTRY, _TESTMAP_MAPINT32FOREIGNMESSAGEENTRY,
...
_TESTARENAMAP = _descriptor.Descriptor(
	...
	fields=[
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='map_int32_foreign_message', full_name='protobuf_unittest.TestArenaMap.map_int32_foreign_message',
			index=16,
			number=17, type=11, cpp_type=10, label=3,
			has_default_value=False, default_value=[],
			message_type=None, enum_type=None, containing_type=None,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='map_int32_foreign_message_no_arena',
			full_name='protobuf_unittest.TestArenaMap.map_int32_foreign_message_no_arena', index=17,
			number=18, type=11, cpp_type=10, label=3,
			has_default_value=False, default_value=[],
			message_type=None, enum_type=None, containing_type=None,
			is_extension=False, extension_scope=None,
	...
	nested_types=[_TESTARENAMAP_MAPINT32INT32ENTRY, _TESTARENAMAP_MAPINT64INT64ENTRY,
				  _TESTARENAMAP_MAPUINT32UINT32ENTRY, _TESTARENAMAP_MAPUINT64UINT64ENTRY,
				  _TESTARENAMAP_MAPSINT32SINT32ENTRY, _TESTARENAMAP_MAPSINT64SINT64ENTRY,
				  _TESTARENAMAP_MAPFIXED32FIXED32ENTRY, _TESTARENAMAP_MAPFIXED64FIXED64ENTRY,
				  _TESTARENAMAP_MAPSFIXED32SFIXED32ENTRY, _TESTARENAMAP_MAPSFIXED64SFIXED64ENTRY,
				  _TESTARENAMAP_MAPINT32FLOATENTRY, _TESTARENAMAP_MAPINT32DOUBLEENTRY, _TESTARENAMAP_MAPBOOLBOOLENTRY,
				  _TESTARENAMAP_MAPSTRINGSTRINGENTRY, _TESTARENAMAP_MAPINT32BYTESENTRY, _TESTARENAMAP_MAPINT32ENUMENTRY,
				  _TESTARENAMAP_MAPINT32FOREIGNMESSAGEENTRY, _TESTARENAMAP_MAPINT32FOREIGNMESSAGENOARENAENTRY, ],
	enum_types=[
	],
	serialized_options=None,
	is_extendable=False,
...
_TESTMAP_MAPINT32FOREIGNMESSAGEENTRY.fields_by_name[
...
_TESTMAP_MAPSTRINGFOREIGNMESSAGEENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__pb2._FOREIGNMESSAGE
_TESTMAP_MAPSTRINGFOREIGNMESSAGEENTRY.containing_type = _TESTMAP
_TESTMAP_MAPINT32ALLTYPESENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__pb2._TESTALLTYPES
...
_TESTMESSAGEMAP_MAPINT32MESSAGEENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__pb2._TESTALLTYPES
...
_TESTREQUIREDMESSAGEMAP_MAPFIELDENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__pb2._TESTREQUIRED
...
_TESTARENAMAP_MAPINT32FOREIGNMESSAGEENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__pb2._FOREIGNMESSAGE
_TESTARENAMAP_MAPINT32FOREIGNMESSAGEENTRY.containing_type = _TESTARENAMAP
_TESTARENAMAP_MAPINT32FOREIGNMESSAGENOARENAENTRY.fields_by_name[
	'value'].message_type = google_dot_protobuf_dot_unittest__no__arena__pb2._FOREIGNMESSAGE
...
_TESTARENAMAP.fields_by_name[
	'map_int32_foreign_message_no_arena'].message_type = _TESTARENAMAP_MAPINT32FOREIGNMESSAGENOARENAENTRY
...
TestMap = _reflection.GeneratedProtocolMessageType('TestMap', (_message.Message,), {
	...
	'MapInt32ForeignMessageEntry': _reflection.GeneratedProtocolMessageType('MapInt32ForeignMessageEntry',
																			(_message.Message,), {
...
TestArenaMap = _reflection.GeneratedProtocolMessageType('TestArenaMap', (_message.Message,), {
	...
	'MapInt32ForeignMessageNoArenaEntry': _reflection.GeneratedProtocolMessageType('MapInt32ForeignMessageNoArenaEntry',
																				   (_message.Message,), {
...
MessageContainingEnumCalledType = _reflection.GeneratedProtocolMessageType('MessageContainingEnumCalledType',
																		   (_message.Message,), {
																			   ...
																			   'TypeEntry': _reflection.GeneratedProtocolMessageType(
																				   'TypeEntry', (_message.Message,), {
...
MessageContainingMapCalledEntry = _reflection.GeneratedProtocolMessageType('MessageContainingMapCalledEntry',
																		   (_message.Message,), {

																			   'EntryEntry': _reflection.GeneratedProtocolMessageType(
																				   'EntryEntry', (_message.Message,), {
