...
optional_nested_message_extension = _descriptor.FieldDescriptor(
	...
	full_name='google.protobuf.python.internal.optional_nested_message_extension', index=0,
...
repeated_nested_message_extension = _descriptor.FieldDescriptor(
	...
	full_name='google.protobuf.python.internal.repeated_nested_message_extension', index=1,
...
_TESTALLTYPES = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.TestAllTypes.repeated_nested_message', index=0,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.TestAllTypes.optional_nested_message', index=1,
			number=2, type=11, cpp_type=10, label=1,
			has_default_value=False, default_value=None,
			message_type=None, enum_type=None, containing_type=None,
			is_extension=False, extension_scope=None,
