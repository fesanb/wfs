...
_TESTMESSAGESETEXTENSION1 = _descriptor.Descriptor(
	...
	extensions=[
		_descriptor.FieldDescriptor(
			name='message_set_extension', full_name='protobuf_unittest.TestMessageSetExtension1.message_set_extension',
			index=0,
...
_TESTMESSAGESETEXTENSION2 = _descriptor.Descriptor(
	...
	extensions=[
		_descriptor.FieldDescriptor(
			name='message_set_extension', full_name='protobuf_unittest.TestMessageSetExtension2.message_set_extension',
			index=0,
...
_TESTMESSAGESETCONTAINER.fields_by_name[
	'message_set'].message_type = google_dot_protobuf_dot_unittest__mset__wire__format__pb2._TESTMESSAGESET
_TESTMESSAGESETEXTENSION1.fields_by_name[
	'recursive'].message_type = google_dot_protobuf_dot_unittest__mset__wire__format__pb2._TESTMESSAGESET
