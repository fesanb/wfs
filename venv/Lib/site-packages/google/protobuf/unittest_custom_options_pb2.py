...
DESCRIPTOR = _descriptor.FileDescriptor(
	...
	serialized_options=_b(
		'\200\001\001\210\001\001\220\001\001\360\350\301\035\352\255\300\345$\372\354\205;p\010d\022\016FileAnnotation\032\026\022\024NestedFileAnnotation\"\036\372\354\205;\031\022\027FileExtensionAnnotation*$\013\020\366\353\256\007\032\033\n\031EmbeddedMessageSetElement\014'),
	serialized_pb=_b(
...
_TESTMESSAGEWITHCUSTOMOPTIONS = _descriptor.Descriptor(
	...
	oneofs=[
		_descriptor.OneofDescriptor(
			...
			serialized_options=_b('\370\254\303\035\235\377\377\377\377\377\377\377\377\001')),
	],
...
_CUSTOMOPTIONOTHERVALUES = _descriptor.Descriptor(
	...
	serialized_options=_b(
		'\350\306\262\035\234\377\377\377\377\377\377\377\377\001\365\337\243\035\347\207EA\351\334\242\035\373Y\214B\312\300\363?\252\334\242\035\016Hello, \"World\"\262\331\242\035\013Hello\000World\210\331\242\035\351\377\377\377\377\377\377\377\377\001'),
	is_extendable=False,
	syntax='proto2',
	extension_ranges=[],
	oneofs=[
...
_COMPLEXOPTIONTYPE2_COMPLEXOPTIONTYPE4 = _descriptor.Descriptor(
	...
	extensions=[
		_descriptor.FieldDescriptor(
			name='complex_opt4', full_name='protobuf_unittest.ComplexOptionType2.ComplexOptionType4.complex_opt4',
			index=0,
...
_AGGREGATEMESSAGESETELEMENT = _descriptor.Descriptor(
	...
	extensions=[
		_descriptor.FieldDescriptor(
			...
			full_name='protobuf_unittest.AggregateMessageSetElement.message_set_extension', index=0,
...
_TESTMESSAGEWITHCUSTOMOPTIONS.fields_by_name['oneof_field'].containing_oneof = \
_TESTMESSAGEWITHCUSTOMOPTIONS.oneofs_by_name['AnOneof']
...
TestMessageWithCustomOptions = _reflection.GeneratedProtocolMessageType('TestMessageWithCustomOptions',
																		(_message.Message,), {
...
CustomOptionFooClientMessage = _reflection.GeneratedProtocolMessageType('CustomOptionFooClientMessage',
																		(_message.Message,), {
...
CustomOptionFooServerMessage = _reflection.GeneratedProtocolMessageType('CustomOptionFooServerMessage',
																		(_message.Message,), {
...
DummyMessageInvalidAsOptionType = _reflection.GeneratedProtocolMessageType('DummyMessageInvalidAsOptionType',
																		   (_message.Message,), {
...
CustomOptionMinIntegerValues = _reflection.GeneratedProtocolMessageType('CustomOptionMinIntegerValues',
																		(_message.Message,), {
...
CustomOptionMaxIntegerValues = _reflection.GeneratedProtocolMessageType('CustomOptionMaxIntegerValues',
																		(_message.Message,), {
...
SettingRealsFromPositiveInts = _reflection.GeneratedProtocolMessageType('SettingRealsFromPositiveInts',
																		(_message.Message,), {
...
SettingRealsFromNegativeInts = _reflection.GeneratedProtocolMessageType('SettingRealsFromNegativeInts',
																		(_message.Message,), {
...
TestMessageWithRequiredEnumOption = _reflection.GeneratedProtocolMessageType('TestMessageWithRequiredEnumOption',
																			 (_message.Message,), {
...
_COMPLEXOPTIONTYPE2_COMPLEXOPTIONTYPE4.extensions_by_name[
	'complex_opt4'].message_type = _COMPLEXOPTIONTYPE2_COMPLEXOPTIONTYPE4
...
TestServiceWithCustomOptions = service_reflection.GeneratedServiceType('TestServiceWithCustomOptions',
																	   (_service.Service,), dict(
		DESCRIPTOR=_TESTSERVICEWITHCUSTOMOPTIONS,
		__module__='google.protobuf.unittest_custom_options_pb2'
	))

TestServiceWithCustomOptions_Stub = service_reflection.GeneratedServiceStubType('TestServiceWithCustomOptions_Stub',
																				(TestServiceWithCustomOptions,), dict(
		DESCRIPTOR=_TESTSERVICEWITHCUSTOMOPTIONS,
		__module__='google.protobuf.unittest_custom_options_pb2'
	))
