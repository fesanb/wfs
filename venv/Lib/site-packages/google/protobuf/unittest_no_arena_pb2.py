...
DESCRIPTOR = _descriptor.FileDescriptor(
	...
	dependencies=[google_dot_protobuf_dot_unittest__import__pb2.DESCRIPTOR,
				  google_dot_protobuf_dot_unittest__arena__pb2.DESCRIPTOR, ])
...
_TESTALLTYPES = _descriptor.Descriptor(
	...
	fields=[
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_nested_message', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_nested_message',
			index=16,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='protobuf_unittest_no_arena.TestAllTypes.optional_foreign_message', index=17,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_import_message', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_import_message',
			index=18,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_nested_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_nested_enum',
			index=19,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_foreign_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_foreign_enum',
			index=20,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_import_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_import_enum',
			index=21,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='optional_string_piece', full_name='protobuf_unittest_no_arena.TestAllTypes.optional_string_piece',
			index=22,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='protobuf_unittest_no_arena.TestAllTypes.optional_public_import_message', index=24,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_nested_message', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_nested_message',
			index=42,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_foreign_message', index=43,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_import_message', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_import_message',
			index=44,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_nested_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_nested_enum',
			index=45,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_foreign_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_foreign_enum',
			index=46,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_import_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_import_enum',
			index=47,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_string_piece', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_string_piece',
			index=48,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=_b('\010\001'), file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='repeated_lazy_message', full_name='protobuf_unittest_no_arena.TestAllTypes.repeated_lazy_message',
			index=50,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='default_nested_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.default_nested_enum',
			index=66,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='default_foreign_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.default_foreign_enum',
			index=67,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='default_import_enum', full_name='protobuf_unittest_no_arena.TestAllTypes.default_import_enum',
			index=68,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='default_string_piece', full_name='protobuf_unittest_no_arena.TestAllTypes.default_string_piece',
			index=69,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='oneof_nested_message', full_name='protobuf_unittest_no_arena.TestAllTypes.oneof_nested_message',
			index=72,
		...
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='lazy_oneof_nested_message',
			full_name='protobuf_unittest_no_arena.TestAllTypes.lazy_oneof_nested_message', index=75,
...
_TESTNOARENAMESSAGE.fields_by_name[
	'arena_message'].message_type = google_dot_protobuf_dot_unittest__arena__pb2._ARENAMESSAGE
