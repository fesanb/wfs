...
_TESTMESSAGESETWIREFORMATCONTAINER = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='message_set', full_name='proto2_wireformat_unittest.TestMessageSetWireFormatContainer.message_set',
			index=0,
...
TestMessageSetWireFormatContainer = _reflection.GeneratedProtocolMessageType('TestMessageSetWireFormatContainer',
																			 (_message.Message,), {
