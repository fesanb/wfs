...
_TESTENUMVALUES = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.TestEnumValues.optional_nested_enum', index=0,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.TestEnumValues.repeated_nested_enum', index=1,
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='packed_nested_enum', full_name='google.protobuf.python.internal.TestEnumValues.packed_nested_enum',
			index=2,
...
_TESTMISSINGENUMVALUES = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='optional_nested_enum',
			full_name='google.protobuf.python.internal.TestMissingEnumValues.optional_nested_enum', index=0,
			number=1, type=14, cpp_type=8, label=1,
		...
		_descriptor.FieldDescriptor(
			name='repeated_nested_enum',
			full_name='google.protobuf.python.internal.TestMissingEnumValues.repeated_nested_enum', index=1,
			number=2, type=14, cpp_type=8, label=3,
			has_default_value=False, default_value=[],
			message_type=None, enum_type=None, containing_type=None,
			is_extension=False, extension_scope=None,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.TestMissingEnumValues.packed_nested_enum', index=2,
			number=3, type=14, cpp_type=8, label=3,
			has_default_value=False, default_value=[],
			message_type=None, enum_type=None, containing_type=None,
			is_extension=False, extension_scope=None,
