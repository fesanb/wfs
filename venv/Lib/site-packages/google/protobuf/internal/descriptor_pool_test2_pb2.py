...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			name='nested_enum',
			full_name='google.protobuf.python.internal.DescriptorPoolTest3.NestedMessage.nested_enum', index=0,
			number=1, type=14, cpp_type=8, label=1,
		...
		_descriptor.FieldDescriptor(
			name='nested_field',
			full_name='google.protobuf.python.internal.DescriptorPoolTest3.NestedMessage.nested_field', index=1,
			number=2, type=9, cpp_type=9, label=1,
		...
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.DescriptorPoolTest3.NestedMessage.deep_nested_message', index=2,
...
_DESCRIPTORPOOLTEST3 = _descriptor.Descriptor(
	...
	fields=[
		_descriptor.FieldDescriptor(
			...
			serialized_options=None, file=DESCRIPTOR),
		_descriptor.FieldDescriptor(
			name='nested_message', full_name='google.protobuf.python.internal.DescriptorPoolTest3.nested_message',
			index=1,
	...
	extensions=[
		_descriptor.FieldDescriptor(
			...
			full_name='google.protobuf.python.internal.DescriptorPoolTest3.descriptor_pool_test', index=0,
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE.fields_by_name[
	'nested_enum'].enum_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE_NESTEDENUM
...
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE.fields_by_name[
	'nested_enum'].enum_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_NESTEDENUM
_DESCRIPTORPOOLTEST3_NESTEDMESSAGE.fields_by_name[
	'deep_nested_message'].message_type = _DESCRIPTORPOOLTEST3_NESTEDMESSAGE_DEEPNESTEDMESSAGE
